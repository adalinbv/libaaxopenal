...
#define EXTENSION		"AL_AAX_reverb"
...
#if 0
         alStatef(source, AL_AAX_REVERB_PRE_DELAY_TIME, 0.0033);
         alSatetf(source, AL_AAX_REVERB_REFLECTION_TIME, 0.06);
         alSatetf(source, AL_AAX_REVERB_REFLECTION_FACTOR, 0.5);
         alSatetf(source, AL_AAX_REVERB_DECAY_TIME, 25.0);
         alSateti(source, AL_AAX_REVERB_ENABLE, AL_TRUE);
#endif
         testForALError();
