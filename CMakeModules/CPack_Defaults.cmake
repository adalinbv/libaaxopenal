...
SET(CPACK_RESOURCE_FILE_LICENSE "${aaxopenal_SOURCE_DIR}/COPYING" CACHE INTERNAL "Copyright" FORCE)
...
# SET(CPACK_PACKAGE_FILE_NAME "${PACKAGE_NAME}-${CPACK_PACKAGE_VERSION}")
  SET(CPACK_PACKAGE_INSTALL_DIRECTORY CACHE INTERNAL "AeonWave"  FORCE)
  SET(CPACK_PACKAGE_FILE_NAME "${PACKAGE_NAME}-${CPACK_PACKAGE_VERSION}")
...
ELSE(WIN32)
  ...
  SET(CPACK_DEBIAN_CHANGELOG_FILE "${aaxopenal_SOURCE_DIR}/ChangeLog")
  ...
  SET(CPACK_RPM_CHANGELOG_FILE "${aaxopenal_SOURCE_DIR}/ChangeLog")
  SET(CPACK_RPM_COMPONENT_INSTALL ON)
ENDIF(WIN32)

# ZIP
IF(EXISTS ${aaxopenal_SOURCE_DIR}/.gitignore)
  FILE(STRINGS ${aaxopenal_SOURCE_DIR}/.gitignore CPACK_SOURCE_IGNORE_FILES)
ENDIF(EXISTS ${aaxopenal_SOURCE_DIR}/.gitignore)

SET(CPACK_SOURCE_GENERATOR "ZIP")
SET(CPACK_SOURCE_IGNORE_FILES
    "^${aaxopenal_SOURCE_DIR}/.git;\\\\.gitignore;Makefile.am;~$;${CPACK_SOURCE_IGNORE_FILES}" CACHE INTERNAL "Ignore files" FORCE)
